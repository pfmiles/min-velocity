package com.github.pfmiles.org.apache.velocity.app;
...
import com.github.pfmiles.org.apache.velocity.runtime.RuntimeInstance;
import com.github.pfmiles.org.apache.velocity.runtime.log.Log;

/**
 * <p>
 * This class provides a separate new-able instance of the Velocity template
 * engine. The alternative model for use is using the Velocity class which
 * employs the singleton model.
 * </p>
 * <p>
 * Velocity will call the parameter-less init() at the first use of this class
 * if the init() wasn't explicitly called. While this will ensure that Velocity
 * functions, it probably won't function in the way you intend, so it is
 * strongly recommended that you call an init() method yourself if you use the
 * default constructor.
 * </p>
 * 
