package com.github.pfmiles.org.apache.velocity.runtime.resource;
...
import com.github.pfmiles.org.apache.velocity.runtime.resource.loader.ResourceLoader;
import com.github.pfmiles.org.apache.velocity.runtime.resource.loader.ResourceLoaderFactory;
    ...
    implements ResourceManager
{
    ...
    public synchronized void initialize(final RuntimeServices rsvc)
    {
        ...
        if (com.github.pfmiles.org.apache.commons.lang.StringUtils.isNotEmpty(cacheClassName))
        {
            try
            {
        ...
        throws ResourceNotFoundException, ParseErrorException
    {
        ...
        if (resource.isSourceModified())
        {
            ...
            if (!com.github.pfmiles.org.apache.commons.lang.StringUtils.equals(resource.getEncoding(), encoding))
            {
